...
//        Toast.makeText(mContext, ""+location.getLatitude(), Toast.LENGTH_SHORT).show();
        Log.d("LocoMoco" , ""+location.getLatitude());

        session.setUserLocation(location.getLatitude() +","+ location.getLongitude());

//        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference();
//        DatabaseReference UserTableDataReference = databaseReference.child("user");
//        UserTableDataReference.child(session.getUserDetails().get("user_id")).child("location").setValue(""+location.getLatitude() +","+ location.getLongitude());
    }
